    ...
    <div class="home-manage">
      <div class="people-container">
        <div class="d-flex align-items-center">
          <span class="container-title">Sellers</span>
      ...
      <div class="stats-container">
        ...
        <div class="d-flex flex-wrap">
          ...
          <div class="state-item">
            ...
            <span class="state-text">Customer Closing Confirmed</span>
          </div>
          <div class="state-item">
          ...
          <div class="state-item">
            ...
            <span class="state-text">Home Listed</span>
          </div>
          <div class="state-item">
            <span class="state-count">23</span>
            <span class="state-text">Purchaser Submitted Offer</span>
          </div>
          <div class="state-item">
            <span class="state-count">45</span>
            <span class="state-text">Home Sold</span>
          </div>
        </div>
      </div>
    </div>
